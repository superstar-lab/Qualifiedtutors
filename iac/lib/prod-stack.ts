...
export class ProdStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const elbSecurityGroup = new ec2.SecurityGroup(this, 'elvSecurityGroup', {
        allowAllOutbound: true,
    ...
    asgSecurityGroup.connections.allowFrom(elbSecurityGroup, ec2.Port.tcp(443), 'Application Load Balancer Security Group')
    asgSecurityGroup.connections.allowFrom(bastionSecurityGroup, ec2.Port.tcp(22), 'Allows connections from bastion hosts')
    ...
    */
    ...
    const ebAppName = "QualifiedTutorsAPI"
    ...
    */
    ...
    const elbEnv = new elasticbeanstalk.CfnEnvironment(this, 'Environment', {
        environmentName: 'Prod-QualifiedTutors-API',
    ...
    const db = new rds.DatabaseInstance(this, 'Prod-QualifiedTutors-DB', {
    ...
    const feOriginIdent = new cloudfront.OriginAccessIdentity(this, "frontend-oai")
    frontendBucket.grantRead(feOriginIdent)
    const cfDistro = new cloudfront.CloudFrontWebDistribution(this, "frontend-cdn", {
        originConfigs: [{
            s3OriginSource: {
        ...
        viewerCertificate: {
            ...
            aliases: [
                "qualifiedtutors.bypass.systems"
            ]
        }
    })

    /*
    const feDeployment = new s3deploy.BucketDeployment(this, 'FrontendBucketDeployment', {
        sources: [
